...
# Usage:
# sudo ./ppp-creator.sh <apn> <serial port>
# the serial port already contains /dev/, so just fill for which tty*
# Ex: ./ppp-creator.sh internet.iot ttyS5

# echo "install ppp"
# sudo apt-get install ppp
# pre-install in image
sudo chmod +x /sbin/pppd
